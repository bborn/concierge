module Concierge
  module Spike
    # SPIKE (phase-10 step 0, §10.5). Throwaway — see lib/concierge/spike.rb.
    #
    # The per-agent authority envelope: what this agent may do on its own, keyed
    # by action class. Replaces the single global +draft_and_review+ boolean.
    #
    #   authority do
